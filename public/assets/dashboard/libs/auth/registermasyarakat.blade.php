          ...
          <div class="card">
            <div class="card-body">
              ...
              @if (session()->has('sukses registrasi'))
                        ...
                        @endif
              <form id="formAuthentication" class="mb-3" action="{{ route('registermasyarakat.store') }}" method="POST">
                @csrf
                <div class="mb-3">
                  ...
                  <input
                    ...
                    class="form-control"
                    id="nik"
                    name="nik" @error('nik') is-invalid @enderror
              ...
              @enderror
                ...
                <div class="mb-3">
                  ...
                  <input
                    ...
                    class="form-control"
                    id="nama"
                    name="nama" @error('nama') is-invalid @enderror
                    placeholder="Enter your username"
                    autofocus
                    required = ""
                  />
              ...
              @enderror
                ...
                <div class="mb-3">
                  ...
                  <input
                    ...
                    class="form-control"
                    id="telp"
                    name="telp" @error('telp') is-invalid @enderror
                    placeholder="Enter your username"
                    autofocus
                    required = ""
                  />
              ...
              @enderror
                ...
                <div class="mb-3">
                  ...
                  <input
                    ...
                    class="form-control"
                    id="username"
                    name="username" @error('username') is-invalid @enderror
                    placeholder="Enter your username"
                    autofocus
                    required = ""
                  />
                ...
                <button class="btn btn-primary d-grid w-100" value="login">Sign up</button>
              </form>
